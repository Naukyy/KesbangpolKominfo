...
<head>
    ...
    <title>Reset Password - DocManager</title>
    ...
    <div class="reset-container">
        <div class="reset-card">
            <div class="card-header">
                ...
                <p>Silakan atur ulang kata sandi akun Anda</p>
            </div>
            
            <div class="card-body">
                <div class="reset-decoration">
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="Buat kata sandi baru">
                        @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong><i class="fas fa-exclamation-circle me-1"></i>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" placeholder="Konfirmasi kata sandi baru">
                    </div>
